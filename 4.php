...
<h1>PETTY CASH PAYMENT VALIDATION</h1>
<br><br>
...
<form action="uploads/4u.php" method="post">
...
<script>
// Headers
var headers = ["Location", "Voucher No. ", "Description", "Amount","Has the petty cash voucher been approved by an authorized party","Has the petty cash advance voucher been approved by an authorized party","Has the petty cash advance voucher been settled","Is the petty cash expense relevant to the business operation","Has the petty cash bill been certified by the Security staff","Has advance voucher updated in ERP System","Advance Voucher Issue Date","Issue"];
...
function loadData() {
  ...
  xhr.open("GET", "get/getdata3.php?date=" + site + "&site="+site1, true);
  xhr.send();
}
</script>
</body>
