...
<h1>SURPRISE JOB VERIFICATION</h1>
<br><br>
...
<form action="uploads/1u.php" method="post">
<input type="date" name="date" id="date" onchange="loadData()"><br><br>
...
<script>
// Headers
var headers = ["Vehicle Reg. No", "Site", "Work Order no.", "Status", "Planned Start date","Finished Date","Invoice no.","Invoice date"];
...
function loadData() {
  ...
  xhr.open("GET", "get/getdata.php?date=" + site +"&site="+site1, true);
  xhr.send();
}
</script>
