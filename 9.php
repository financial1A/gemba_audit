...
<h1>PURCHASE ORDERS - PURCHASES FOR ACCURANCE & COMPLIANCE</h1>
<br><br>
...
<form action="uploads/9u.php" method="post">
...
<script>
// Headers
var headers = ["Site", "Purchase order no.", "Has the purchase request form been approved by the authorized party ?", "Have three quotations by 3 suppliers?","Has the lower price taken in 3 quotation?","Has the choose quotation approved by authorized party ?","Has put the purchase order?","Is there gap between GRN and Supplier invoice ? ","Has the payment voucher been approved by authorized party ?","Note"];
...
function loadData() {
  ...
  xhr.open("GET", "get/getdata8.php?date=" + site +"&site="+site1, true);
  xhr.send();
}
</script>
</body>
