...
$a49 = str_replace(array("'","\""),"",$_POST['49']);
 ...
 $a81 = str_replace(array("'","\""),"",$_POST['81']);
 $a82 = str_replace(array("'","\""),"",$_POST['82']);
 $a83 = str_replace(array("'","\""),"",$_POST['83']);
 $a84 = str_replace(array("'","\""),"",$_POST['84']);
 $a85 = str_replace(array("'","\""),"",$_POST['85']);
 $a86 = str_replace(array("'","\""),"",$_POST['86']);
 $a87 = str_replace(array("'","\""),"",$_POST['87']);
 $a88 = str_replace(array("'","\""),"",$_POST['88']);
 $a89 = str_replace(array("'","\""),"",$_POST['89']);
 $a90 = str_replace(array("'","\""),"",$_POST['90']);
$a611 = str_replace(array("'", "\""), "", $_POST['date']);
$site = str_replace(array("'", "\""), "", $_POST['site']);

// Prepare and bind
$sql = "INSERT INTO CashInvoice (Location, CashInvoiceNo, CustomerId, SettlementOfCashInvoice, TemporaryCreditSale, CreditApplicationFormAttached, GatePassIssued, ItemsDelivered, CalculationAccuracy,date,site) 
VALUES ('$a1','$a2','$a3','$a4','$a5','$a6','$a7','$a8','$a9','$a611','$site'),
('$a10','$a11','$a12','$a13','$a14','$a15','$a16','$a17','$a18','$a611','$site'),
('$a19','$a20','$a21','$a22','$a23','$a24','$a25','$a26','$a27','$a611','$site'),
('$a28','$a29','$a30','$a31','$a32','$a33','$a34','$a35','$a36','$a611','$site'),
('$a37','$a38','$a39','$a40','$a41','$a42','$a43','$a44','$a45','$a611','$site'),
('$a46','$a47','$a48','$a49','$a50','$a51','$a52','$a53','$a54','$a611','$site'),
('$a55','$a56','$a57','$a58','$a59','$a60','$a61','$a62','$a63','$a611','$site'),
('$a64','$a65','$a66','$a67','$a68','$a69','$a70','$a71','$a72','$a611','$site'),
('$a73','$a74','$a75','$a76','$a77','$a78','$a79','$a80','$a81','$a611','$site'),
('$a82','$a83','$a84','$a85','$a86','$a87','$a88','$a89','$a90','$a611','$site')
";
