...
// Prepare and bind
$sql = "INSERT INTO PettyCash (Location, VoucherNo, Description, Amount, VoucherApproved, AdvanceVoucherApproved, AdvanceVoucherSettled, ExpenseRelevance, BillCertified, AdvanceVoucherUpdated, AdvanceVoucherIssueDate, Issue,date,site)
