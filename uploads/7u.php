...
// Prepare and bind
$sql = "INSERT INTO CreditSaleInvoice (CustomerId, CreditSaleInvoiceNo, InvoiceDate, ERPUpdateDate, ERPUpdateDelay, PhysicalMovementOfGoods, ReturnInvoiceNo, SaleReturnDate, SaleReturnDelay, Note,date,site)
