...
<h1>INVOICE GENERATION - PR , PRINTED</h1>
<br><br>
...
<form action="uploads/8u.php" method="post">
...
<script>
// Headers
var headers = ["Site", "Series Id.", "Invoice no.", "Preliminary invoice no.","Invoice Status","Invoice type","Total net amount","Invoice Date","Order No.","Responsible Staff"];
...
function loadData() {
  ...
  xhr.open("GET", "get/getdata7.php?date=" + site + "&site="+site1, true);
  xhr.send();
}
</script>
</body>
